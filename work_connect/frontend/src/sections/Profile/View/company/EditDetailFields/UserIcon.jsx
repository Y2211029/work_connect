...
const ImageCard = ({ IconData, userName }) => {
  ...
  useEffect(() => {
    if (getSessionData("accountData") !== undefined) {
      ...
      if (SessionData.CompanyIconEditing && SessionData.CompanyIcon) {
        ...
        ((SessionData.CompanyIconEditing && SessionData.CompanyIcon && IconData) || (!SessionData.CompanyIconEditing && IconData)) &&
        ...
        >
          {selectedImage ? (
            <CardMedia
              ...
              image={selectedImage ? `http://localhost:8000/storage/images/userIcon/${selectedImage}` : ""}
              alt=""
            />
          ) : (
            <DefaultIcon
          ...
          <input accept=".jpg,.jpeg,.png" style={{ display: "none" }} id="icon-button-file" type="file" onChange={handleImageChange} />
